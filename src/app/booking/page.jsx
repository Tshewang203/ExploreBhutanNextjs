  ...
  return (
    <Layout>
      ...
      <div className="pt-20">
        ...
        {/* Tour Packages Section - update onClick handler */}
        ...
        <div id="booking-form" className="py-16 bg-[var(--rice-white)]">
          <div className="container mx-auto px-4">
        ...
        <section className="py-16 bg-[var(--rice-white)]">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center p-6 bg-white rounded-lg shadow-lg">
                <div className="text-4xl mb-4">✨</div>
                <h3 className="text-xl font-bold mb-2 font-['Cinzel']">Customized Experiences</h3>
                <p className="font-['Playfair_Display']">
              ...
              <div className="text-center p-6 bg-white rounded-lg shadow-lg">
                <div className="text-4xl mb-4">💯</div>
                <h3 className="text-xl font-bold mb-2 font-['Cinzel']">24/7 Support</h3>
                <p className="font-['Playfair_Display']">
