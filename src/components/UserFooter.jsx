        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/tshewang.lhamo.9047" className="text-2xl hover:text-gray-300"><i className="bi bi-facebook"></i></a>
              <a href="https://www.instagram.com/accounts/login/?hl=en" className="text-2xl hover:text-gray-300"><i className="bi bi-instagram"></i></a>
              <a href="https://x.com/login?" className="text-2xl hover:text-gray-300"><i className="bi bi-twitter"></i></a>
              <a href="http://youtube.com/@Bellingham67-j6i" className="text-2xl hover:text-gray-300"><i className="bi bi-youtube"></i></a>
            </div>
          </div>
        </div>
